...
// Mise à jour de l'état X (Vitesse) par intégration
       const newVx = this.x.subset(math.index(3, 0)) + accels[0] * dt;
       const newVy = this.x.subset(math.index(4, 0)) + accels[1] * dt;
