...
class ProfessionalUKF {
    ...
    processMotion(event) {
        ...
        // Newton : Soustraction de la gravité pour isoler le mouvement propre
        ...
        // Relativité Micro (Précision via Math.js)
    ...
    updateUI(x, y, z, effA, status, lorentz) {
        ...
        set('acc-x', x.toFixed(2)); set('acc-y', y.toFixed(2)); set('acc-z', z.toFixed(2));
        ...
        // BASCULE SCIENTIFIQUE AUTO pour Lorentz (Vitesse Micro)
