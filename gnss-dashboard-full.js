// =================================================================
// GNSS SPACETIME DASHBOARD - FICHIER FINAL PROFESSIONNEL (V34)
// OPTIMISATION V34: Consolidation du code pour la robustesse des API natives 
// (devicemotion et geolocation) et garantie de l'exécution complète.
// =================================================================
...
((window) => {
    ...
    const handleDeviceMotion = (event) => {
        ...
        curGyro = {
            // Conversion en Radians/seconde (rad/s)
            x: rot.alpha * D2R || 0.0, 
            y: rot.beta * D2R || 0.0,  
            z: rot.gamma * D2R || 0.0  
        };
    ...
    const toggleGpsPause = () => {
        ...
        if (isGpsPaused) {
            ...
            initGPS(); 
            // API Robuste pour l'IMU (devicemotion)
